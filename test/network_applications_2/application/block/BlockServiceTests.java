...
public class BlockServiceTests {
    ...
    @Test
    public void testAddMessagesSendsBlockToChain() throws BlockFormatException, ChainFormatException {
        blockService.addMessages(messages);
        verify(chainService).addBlock(any(Block.class));
    }

    @Test
    public void testAddMessagesTooManyFreeMoneyMessagesThrowsError() throws MessageFormatException, BlockFormatException, ChainFormatException {
